...
#
#  python delete_snapshot.py CREDENTIALS_FILE PROJECT SNAPSHOTNAME
#
...
def main(argv=None):
    ...
    request = snapshots.delete(project=project, snapshot=snapshot_name)
